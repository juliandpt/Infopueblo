...
for card in cards:
    ...
    try:
        ...
        hotel = driver.find_element_by_xpath('/html/body/div[4]/div/div[1]/div/div/div/div/div[1]/main/div/div/div[1]/div[1]/div/div/div/div/section/div[1]/h1')
        # hotel.getAttribute("value")
        print(hotel)
